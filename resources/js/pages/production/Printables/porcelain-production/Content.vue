<template>
    ...
    <div>
        <h5 class="mx-2 my-1 non-print-elm text-center font-weight-bold" style="text-decoration: underline;">OC PICTURES (PORCELAIN)</h5>
        <h5 class="mx-2 mt-3 mb-n1 non-print-elm text-center">In Production</h5>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div>
                                <b-table  bordered class="printable-production-table-border" :items="items" :fields="fields">
                                    ...
                                    <template #cell(initials)="data">
                                        <b-form-input type="text" readonly class="input-xs my-0 bg-white" size="sm"></b-form-input>
                                    </template>
                                    <template #cell(total_sq_ft)="data">
                                        <b-form-input type="text"  class="input-sm my-0 bg-white" size="sm"></b-form-input>
                                    </template>
                                    <template #cell(invoice_no)="data">
                                        <b-form-input type="text" readonly class="input-md my-0 bg-white" size="sm"></b-form-input>
                                    </template>
                                    <template #cell(date)="data">
                                        <b-form-input type="text" readonly class="input-md my-0 bg-white" size="sm"></b-form-input>
                                    </template>
                                    <template #cell(last_name)="data">
                                        <b-form-input type="text" readonly class="input-lg my-0 bg-white" size="sm"></b-form-input>
                                    </template>
                                    <template #cell(size_of_die)="data">
                                        <b-form-input type="text" readonly class="input-xl my-0 bg-white" size="sm"></b-form-input>
                                    </template>
