<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Price Sheet by Number</h5>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    <div class="quote-body p-3">
                        <div class="d-flex">
                            <b-dropdown class="m-2 custom-choose-btn d-none " id="dropdown-form"
                                        ref="dropdown" size="sm" text="Choose Columns" variant="info custom-choose-text">
                            ...
                            <div class="d-flex ml-auto">
                                ...
                                <b-pagination :per-page="pagePerPage" :total-rows="rows"
                                              align="right" aria-controls="data-table" class="my-auto ml-2" size="sm" v-model="currentPage"
                                ></b-pagination>
                                <b-form-select :options="perPageRecordList" @change="getRecord" class="input-list-md form-control-sm rounded-0 my-1 mx-3"
        ...
        <PDF>
            <div class="pdf" slot="header">
                <h5 class="text-center">Price Sheet by Number</h5>
            </div>
...
<script>
    ...
    export default {
        ...
        metaInfo() {
            return {
                title: `Price Sheet by Number List`,
            }
        },
        computed: {
            perPageRecordList() {
            ...
            filterFields() {
                ...
                const orderMap = [
                    ...
                    {key: 'item_name', loc: 3},
                    {key: 'misc_note_d', loc: 4},
                    {key: 'override_selling_price', loc: 5},
                    {key: 'installation_amount', loc: 6},
                    {key: 'selling_price_with_installation', loc: 7},
                ];
