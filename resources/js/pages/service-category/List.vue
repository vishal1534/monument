<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Service Category List</h5>
        <div class="bg-toolbar my-2 p-1">

            <div class="d-flex justify-content-end align-items-center">

                <div class="d-flex m-auto">
                    <router-link v-if="isCreatePermitted" class="btn custom-infobtn-list custom-infobtn-list-text" to="/service-categories">Add Service Category</router-link>
                </div>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    ...
                    <div class="quote-body p-3">
                        ...
                        <div class="d-flex">
                            <b-dropdown
                                ...
                                <b-dropdown-form class="overflow-auto scroll" style="height: 12vh;">
                                    ...
                                    <template v-for="(objects, key) of filterFields" class="abc">
                                        <h6>{{key}}</h6>
                        ...
                        <b-table id="data-table" class="my-table bootstrap-vue-table a" striped hover responsive bordered small
                            ...
                            <template #cell(action)="data" >
                                <div class="mx-1 custom-input-header">
                                    ...
                                    <router-link class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted" :to="'service-categories/' + data.item.id" >Edit</router-link>
                        ...
                        <Modal :module="'ServiceCategory'" :title="'Service Category'" :recordID="viewRecord"></Modal>
    ...
    export default {
        ...
        computed:{
            ...
            tableData(){
                ...
                return this.$store.getters.getServiceCategoryTableData;
            },
            isBusy(){
