<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Resources List</h5>
        <div class="bg-toolbar my-2 p-1">

            <div class="d-flex justify-content-end align-items-center">

                <div class="d-flex m-auto">
                    <router-link class="btn custom-infobtn-list custom-infobtn-list-text" to="/resource">Add Resource</router-link>
                </div>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    ...
                    <div class="quote-body p-3">
                        ...
                        <b-table id="data-table" class="my-table bootstrap-vue-table" striped hover responsive bordered small
                                 :items="tableData"
                                 :fields="tableFields"
                                 :busy="isBusy"
                                 :per-page="perPage"
                            ...
                            <template #cell(action)="data" >
                                <div class="mx-1 custom-input-header">
                                    ...
                                    <router-link class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted" :to="'resource/' + data.item.id" >Edit</router-link>
                        ...
                        <Modal :module="'Resources'" :title="'Resource'" :recordID="viewRecord"></Modal>
    ...
    export default {
        ...
        computed:{
            ...
            tableData(){
                ...
                return this.$store.getters.getResourceTableDate;
