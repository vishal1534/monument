     ...
     <div class="bg-toolbar my-2 p-1">
         ...
         <div class="d-flex justify-content-end align-items-center">
             ...
             <div class="d-flex m-auto">
                 <router-link class="btn custom-infobtn-list custom-infobtn-list-text" to="/work-order-collaborator-types">Add W/O Collaborator Type</router-link>
             </div>
                     ...
                     <b-table id="data-table" class="my-table bootstrap-vue-table a" striped hover responsive bordered small
                         ...
                         <template #cell(action)="data" >
                             <div class="mx-1 custom-input-header">
                                 ...
                                 <router-link class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted" :to="'work-order-collaborator-type/' + data.item.id" >Edit</router-link>
