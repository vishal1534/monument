            ...
            <div class="form-content">
                ...
                <div class="porcelain-production-row">
                    <div>
                        <b-table bordered class="memorial-table-border"
                                 :items="inPDF ? sandblastList.slice(0,sandblastList.length - 1) : sandblastList"
                                 :fields="fields">
                            ...
                            <template v-slot:cell(size_of_die)="row">
                                <div class="d-flex justify-content-center">
                                    <b-form-input type="text" min="0" class="input-md ml-0" :disabled="hideInModal" size="sm"
                ...
                <div v-if="!hideInModal" class="porcelain-production-row non-print-elm">
                    <div>
                        ...
                        <router-link class="btn btn-sm btn-warning mx-1 px-3 custom-dangerbtn-toolbar custom-dangerbtn-text" to="/sandblasting-production-list">Back To List</router-link>
...
<script>
    ...
    export default {
        ...
        computed: {
            sandblastList() {
                if (this.formFields.sandblast_list.length == 0 || !this.hasNewRow)
                    this.addRow()

                return this.formFields.sandblast_list;
            },
            isUpdatePermitted(){
            ...
            hasNewRow() {
                for (let item of this.formFields.sandblast_list) {
                    if (item.id == 0)
                        return true
                }
                return false;
        ...
        methods: {
            ...
            addRow() {
                if (!this.inPDF)
                    this.formFields.sandblast_list.push({id: 0})
            },
            save: function () {
