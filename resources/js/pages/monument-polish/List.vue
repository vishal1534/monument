<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Monument Polish List</h5>
        <div class="bg-toolbar my-2 p-1">

            <div class="d-flex justify-content-end align-items-center">

                <div class="d-flex m-auto">
                    <router-link v-if="isCreatePermitted" class="btn custom-infobtn-list custom-infobtn-list-text" to="/monument-polish">Add Monument Polish</router-link>
                </div>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    ...
                    <div class="quote-body p-3">
                        ...
                        <b-table id="data-table" class="my-table bootstrap-vue-table a" striped hover responsive bordered small
                            ...
                            <template #cell(action)="data">
                                <div class="mx-1 custom-input-header">
                                    ...
                                    <router-link class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted" :to="'monument-polish/' + data.item.id" >Edit</router-link>
                        ...
                        <Modal :module="'MonumentPolish'" :title="'Monument Polish'" :recordID="viewRecord"></Modal>
    ...
    export default {
        ...
        computed:{
            ...
            tableData(){
                ...
                return this.$store.getters.getMonumentPolishTableData;
            },
            isBusy(){
                ...
                if (confirm("Do you really want to delete this record?")){
                    ...
                    deleteRecord(this.axiosParams, (response) => {
                        if (response.data){
                            ...
                            let params = {module:'monument',detail:'polish',id:this.axiosParams.id}
