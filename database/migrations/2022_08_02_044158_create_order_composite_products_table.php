...
class CreateOrderCompositeProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_composite_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('order_composite_products');
    }
}
