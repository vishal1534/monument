<template>
 <div>
     <h5 class="mx-2 my-1 custom-view-heading">Cemetery Category List</h5>
     <div class="bg-toolbar my-2 p-1">

         <div class="d-flex justify-content-end align-items-center">

             <div class="d-flex m-auto">
                 <router-link class="btn custom-infobtn-list custom-infobtn-list-text" to="/cemetery-category">Add Category</router-link>
             </div>
         ...
         <div class="row m-0">
             <div class="col-md-12">
                 ...
                 <div class="quote-body p-3">
                     ...
                     <b-table id="data-table" class="my-table bootstrap-vue-table a" striped hover responsive bordered small
                         ...
                         <template #cell(action)="data" >
                             <div class="mx-1 custom-input-header">
                                 ...
                                 <router-link class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted" :to="'cemetery-category/' + data.item.id" >Edit</router-link>
                     ...
                     <Modal :module="'CemeteryCategory'" :title="'Cemetery Category'" :recordID="viewRecord"></Modal>
                 </div>
             </div>
         </div>
     </div>
...
<script>
    ...
    export default {
        ...
        metaInfo() {
            return {
                title: `Cemetery Category Info. List`,
            }
        },
        computed:{
            rows(){
            ...
            tableData(){
                return this.$store.getters.getCemeteryCategoryData;
            },
            isBusy(){
            ...
            deleteRecord: function (id) {
                ...
                if (confirm("Do you really want to delete this record?")){
                    ...
                    deleteRecord(this.axiosParams, (response) => {
                        console.log(this.axiosParams,response.data);
                    })
                }
