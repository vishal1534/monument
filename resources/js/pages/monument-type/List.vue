<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Monument Type List</h5>
        <div class="bg-toolbar my-2 p-1">

            <div class="d-flex justify-content-end align-items-center">

                <div class="d-flex m-auto">
                    <router-link v-if="isCreatePermitted" class="btn custom-infobtn-list custom-infobtn-list-text" to="/monument-types">Add Monument Type</router-link>
                </div>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    ...
                    <div class="quote-body p-3">
                            ...
                            <template #cell(action)="data" >
                                <div class="mx-1 custom-input-header">
                                   <b-button class="btn mx-1 py-1 custom-view-btn custom-view-text" v-if="isReadPermitted" v-b-modal.view-modal @click="setViewRecord(data.item.id)" >View</b-button>
                                    <router-link class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted" :to="'monument-types/' + data.item.id" >Edit</router-link>
                       ...
                       <Modal :module="'MonumentType'" :title="'Monument Type'" :recordID="viewRecord"></Modal>
    ...
    export default {
        ...
        computed:{
            ...
            tableData(){
                ...
                return this.$store.getters.getMonumentTypeTableData;
            },
            isBusy(){
