<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Simple Product List</h5>
        <div class="bg-toolbar my-2 p-1">

            <div class="d-flex justify-content-end align-items-center">

                <div class="d-flex m-auto">
                    <router-link class="btn custom-infobtn-list custom-infobtn-list-text" to="/simples" v-if="isCreatePermitted">Add Simple Product</router-link>
                </div>
                    ...
                    <div class="quote-body p-3">
                        ...
                        <b-table :busy="isBusy" :current-page="currentPage" :fields="tableFields" :items="tableData" :no-local-sorting="true" :per-page="pagePerPage"
                            ...
                            <template #cell(image)="data">
                                <img :src="`images/simple/${data.value}`" class="ml-1" height="38" v-if="data.value !=''" width="58"/>
                            </template>
                            ...
                            <template #cell(action)="data" :class="action-flex">
                                <div class="mx-1 custom-input-header">
                                    ...
                                    <router-link :to="'simples/' + data.item.id" class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted">Edit</router-link>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            tableData() {
                //this.$store.getters.sortByAlphaNumeric({'module': 'simple', 'fieldName': 'product_number'});
                return this.$store.getters.getSimpleTableData;
            },
            perPageRecordList(){
        ...
        methods: {
           ...
           /* sortByAscDesc: function () {
            ...
            sortByAscDesc: function () {
                ...
                let tableNames = {
                    'Category': {'columnTableName': 'idInParentTable', 'foreignKey': 'category_id', 'childClassName' : '\\SimpleCategory'},
                    'Simple': {'columnTableName': 'simple', 'childClassName' : ''}
                };
