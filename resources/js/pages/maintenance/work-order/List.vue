<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading"> Maintainance Work Order List </h5>
        <div class="bg-toolbar my-2 p-1">
            <div class="d-flex justify-content-end align-items-center">
                <router-link class="btn custom-infobtn-list custom-infobtn-list-text ml-4" to="/maintenance-work-order" v-if="isCreatePermitted">Add New</router-link>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    <div class="installation-body p-3">
                        ...
                        <b-table :busy="isBusy" :current-page="currentPage" :fields="tableFields" :items="tableData" :no-local-sorting="true" :per-page="pagePerPage"
                            ...
                            <template #cell(action)="data">
                                <div class="mx-1 custom-input-header">
                                    ...
                                    <router-link :to="'/maintenance-work-order/' + data.item.id" class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted">Edit</router-link>
                        ...
                        <Modal :module="'WorkOrder'" :recordID="viewRecord" :title="'Maintainance Work Order'"></Modal>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                sortByColumn: 'id',
                sortByDesc: false,
                columnTableName: 'maintenanceWorkOrder',
                foreignKey: '',
                childClassName: '',
                childTableName: '',
                sortDirection: 'desc',
        ...
        metaInfo() {
            return {
                title: `Maintainance Work Order Forms List`,
            }
        },
        computed: {
            perPageRecordList() {
            ...
            tableData() {
                return this.$store.getters.getWorkOrderTableData;
            },
            isBusy() {
            ...
            isDeletePermitted() {
                return this.$store.getters.isPermitted({resource: 'Maintenance', action: 'delete'});
            },
        },
        components: {
            Modal,
        ...
        methods: {
            ...
            sortByAscDesc: function () {
                this.$store.state[this.axiosParams.module].busy = true
                let tableNames = {
                    'MaintenanceWorkOrder': {'columnTableName': 'maintenanceWorkOrder', 'childClassName': ''}
                };
                ...
                if (this.sortByColumn != 'id' && tableNames[findParent.parent]) {
                    ...
                    this.columnTableName = 'maintenanceWorkOrder';
