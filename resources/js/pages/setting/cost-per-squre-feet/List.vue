<template>
    <div>
        <h5 class="mx-2 my-1 custom-view-heading">Cost P/Sq. Ft. List</h5>
        <div class="bg-toolbar my-2 p-1">
            <div class="d-flex justify-content-end align-items-center">
                <div class="d-flex m-auto">
                    <router-link class="btn custom-infobtn-list custom-infobtn-list-text" to="/cost-per-squre-feet" v-if="isCreatePermitted">Add Cost P/Sq. Ft.</router-link>
                </div>
                <div class="d-flex">
                </div>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    <div class="quote-body p-3">
                        ...
                        <b-table :busy="isBusy" :current-page="currentPage" :fields="tableFields" :items="tableData" :no-local-sorting="true" :per-page="pagePerPage"
                            ...
                            <template #cell(action)="data">
                                <div class="mx-1 custom-input-header">
                                    ...
                                    <router-link :to="'cost-per-squre-feet/' + data.item.id" class="btn mx-1 py-1 custom-edit-btn custom-edit-text" v-if="isUpdatePermitted">Edit</router-link>
                        ...
                        <Modal :module="'CostPSqureFeet'" :recordID="viewRecord" :title="'Cost P/Sq. Ft.'"></Modal>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    import {deleteRecord, fetchRecords, filterRecords} from '../../../helpers/axios';
    ...
    export default {
        ...
        data() {
            return {
                sortByColumn: 'id',
                sortByDesc: false,
                columnTableName: 'costPerSqureFeet',
                foreignKey: '',
                childClassName: '',
                childTableName: '',
                sortDirection: 'desc',
        ...
        computed: {
            ...
            tableData() {
                ...
                return this.$store.getters.getCostPerSqureFeetTableData;
            },
            isBusy() {
            ...
            filterFields() {
                ...
                let hideColumns = ['granite_description']
                const labelMap = {
                    cost_color: 'Color',
                    cost_type: 'Type',
                    granite_sq_ft_price: 'Granite Sq. Ft. Price',
                    cost_vendor: 'Vendor'
                };
                for (const [key, value] of Object.entries(this.$store.state[this.axiosParams.module].columnList)) {
                    ...
                    for (let val of value) {
                        let showColumn = displayCounter > 4 ? 'd-none' : '';
        ...
        methods: {
            ...
            getRecordList: function () {
                fetchRecords(this.axiosParams, (response) => {
            ...
            sortByAscDesc: function () {
                this.$store.state[this.axiosParams.module].busy = true
                let tableNames = {
                    'CostPSqureFeet': {'columnTableName': 'costPerSqureFeet', 'childClassName': ''}
                };
                ...
                if (this.sortByColumn != 'id' && tableNames[findParent.parent]) {
                    ...
                    this.columnTableName = 'costPerSqureFeet';
